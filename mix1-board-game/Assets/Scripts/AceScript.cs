...
private GameObject vbRButton;
    ...
    void Start()
    {
        vbRButton = GameObject.FindGameObjectWithTag("AceRightButton");
        ...
        rPaddle = GameObject.FindGameObjectWithTag("AceRightPaddle");
        rRotationValue = rPaddle.transform.rotation.eulerAngles.y-140;
        
        vbLButton = GameObject.FindGameObjectWithTag("AceLeftButton");
        ...
        lPaddle = GameObject.FindGameObjectWithTag("AceLeftPaddle");
