...
public class JackScript : MonoBehaviour
{
    ...
    void Start()
    {
        vbRButton = GameObject.FindGameObjectWithTag("JackRightButton");
        ...
        rPaddle = GameObject.FindGameObjectWithTag("JackRightPaddle");
        rRotationValue = rPaddle.transform.rotation.eulerAngles.y-140;
        
        vbLButton = GameObject.FindGameObjectWithTag("JackLeftButton");
        ...
        lPaddle = GameObject.FindGameObjectWithTag("JackLeftPaddle");
