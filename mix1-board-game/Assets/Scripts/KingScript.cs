...
public class KingScript : MonoBehaviour
{
    ...
    void Start()
    {
        vbRButton = GameObject.FindGameObjectWithTag("KingRightButton");
        ...
        rPaddle = GameObject.FindGameObjectWithTag("KingRightPaddle");
        rRotationValue = rPaddle.transform.rotation.eulerAngles.y-140;
        
        vbLButton = GameObject.FindGameObjectWithTag("KingLeftButton");
        ...
        lPaddle = GameObject.FindGameObjectWithTag("KingLeftPaddle");
